...
{
    public class PalaceAIGamingRoom : Room
    {
        ...
        private class AI
        {
            ...
            public AI()
            {
                string[] names = new string[]{ "玩家1", "玩家2", "玩家3", "玩家4", "玩家5", };
                Name = names[new Random().Next(0, names.Length-1)];
            }
        }
        public PalaceAIGamingRoom(string customName, PalacePeer player, string roomIndexInApplication, Form1 applicationPointer) : base(customName, player, roomIndexInApplication, applicationPointer)
        {
            _server.printLine("PalaceAIGamingRoom");
        }
        ...
        public override void GamingProcess(byte playerId, Dictionary<byte, object> packet100)
        {
            ...
            switch (switchcode_1)
            {
                ...
                case 1: //Loading Scene Ready
                    //PalacePeer peer = (PalacePeer) players[playerId];
                    //peer.CustomName = packet[1].ToString();
